...
myst:
  html_meta:
    "description": "Plone Aurora training project with a Python CMFPlone backend."
    "property=og:description": "Plone Aurora training project with a Python CMFPlone backend."
    "property=og:title": "Aurora Training Project"
    "keywords": "Aurora Training Project, documentation, Plone Aurora training project with a Python CMFPlone backend."
---

# Aurora Training Project

Welcome to the documentation for Aurora Training Project!
