...
Install aurora.training.project with uv.

```shell
uv add aurora.training.project
```
...
- [Issue tracker](https://github.com/collective/aurora-training-project/issues)
- [Source code](https://github.com/collective/aurora-training-project/)
...
1.  Clone this repository.
    ...
    cd aurora-training-project/backend
    ```
